...
export const WORLDS: World[] = [
  // Worlds 1-5 overhauled to 10 levels each (distinct mental skill + signature +
  ...
  { id: 6, name: 'RIFTS', theme: PHYSICS.COLOR_PORTAL_A, from: 51, to: 58 },
  { id: 7, name: 'GATES', theme: PHYSICS.COLOR_GATE, from: 59, to: 66 },
  { id: 8, name: 'CONVERGENCE', theme: PHYSICS.COLOR_BALL_GLOW, from: 67, to: 74 },
];
